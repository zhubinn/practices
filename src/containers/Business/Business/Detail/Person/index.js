...
import { getTableData, getTableQuery, table_params } from 'actions/business/business/detail/person'
...
class PersonDetail extends React.Component {
    ...
    render() {
        ...
        let queryDataTable = {}
        queryDataTable.dataSource = $$business_detail_person.toJS().rows
        queryDataTable.current = $$business_detail_person.toJS().current
        queryDataTable.total = $$business_detail_person.toJS().total
        queryDataTable.pageSize = $$business_detail_person.toJS().pageSize
        queryDataTable.queryColumns = $$business_detail_person.toJS().queryColumns
        queryDataTable.loading = $$business_detail_person.toJS().loading
        ...
        return (
            <div className="ck-root-main">
                ...
                <Tabs defaultActiveKey="all"
                    ...
                    <TabPane tab="负责的生意" key="owner">
                    </TabPane>
                    <TabPane tab="参与的生意" key="relation">
                    </TabPane>
...
const mapStateToProps = (state, ownProps) => {
    return {
        $$business_detail_person: state.business.business_detail_person
    }
}
