...
const COMPONENTS_ISCHANGEBUSINESS = 'COMPONENTS_ISCHANGEBUSINESS'
const COMPONENTS_ISCHANGECONTACT = 'COMPONENTS_ISCHANGECONTACT'
//是否关联生意
export const isChangeBusiness = (status)=>{
    return {
        type: COMPONENTS_ISCHANGEBUSINESS,
        payload: status,
    }
}

//是否关联客户
export const isChangeContact = (status)=>{
    console.log(status)
    return {
        type: COMPONENTS_ISCHANGECONTACT,
        payload: status,
    }
}
